                ...
                <div className="flex items-center justify-center ">
                  <div className="bg-black flex flex-col w-80 border border-gray-900 rounded-lg px-8 py-10">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col space-y-8 mt-10">
                      ...
                      <input type="text" id="name" name="name" placeholder="name" className="border rounded-lg py-3 px-3 mt-4 bg-black border-indigo-600 placeholder-white-500 text-white" onChange={handleChange} value={formData.name} />

                      <label htmlFor="email" className="font-bold text-lg text-white">Email</label>
                      <input type="email" id="email" name="email" placeholder="Email" className="border rounded-lg py-3 px-3 mt-4 bg-black border-indigo-600 placeholder-white-500 text-white" onChange={handleChange} value={formData.email} />

                      <label htmlFor="phone" className="font-bold text-lg text-white">Phone Number</label>
                      <input type="text" id="phone" name="phone" placeholder="Phone Number" className="border rounded-lg py-3 px-3 mt-4 bg-black border-indigo-600 placeholder-white-500 text-white" onChange={handleChange} value={formData.phone} />

                      <label htmlFor="college" className="font-bold text-lg text-white">College (optional)</label>
                      <input type="text" id="college" name="college" placeholder="College" className="border rounded-lg py-3 px-3 mt-4 bg-black border-indigo-600 placeholder-white-500 text-white" onChange={handleChange} value={formData.college} />


                      <button type="submit" className="border border-indigo-600 bg-black text-white rounded-lg py-3 font-semibold">Submit</button>
                    </form>
                  </div>
                </div>
